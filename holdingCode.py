...
<div class="max-w-6xl mx-auto">
        ...
        {% if user.userprofile.role == 'farmer' and order_analytics %}
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
                ...
                <div class="bg-white p-4 rounded-lg shadow-md cursor-pointer" >          
                    ...
                    <button id="farmerOrdersTab" class="px-4 py-2 font-semibold text-gray-700 border-b-2 border-transparent hover:border-teal-700 focus:outline-none tab-button" onclick="showFarmerOrders()">Orders Made</button>
                    <p>New: {{ order_analytics.new }}</p>
                    <p>Pending: {{ order_analytics.pending }}</p>
                    <p>Confirmed: {{ order_analytics.confirmed }}</p>
                    <p>Completed: {{ order_analytics.completed }}</p>
                </div>
            </div>
        {% endif %}
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
            <!-- <div class="bg-white p-4 rounded-lg shadow-md cursor-pointer" onclick="document.getElementById('myOrdersTab').click();"> -->
            <div class="bg-white p-4 rounded-lg shadow-md cursor-pointer" >
                <button id="myOrdersTab" class="px-4 py-2 font-semibold text-gray-700 border-b-2 border-transparent hover:border-teal-700 focus:outline-none tab-button" onclick="showMyOrders()">My Orders</button>
                <!-- <h3 class="text-lg font-semibold">My Orders</h3> -->
                <p>New: {{ my_order_analytics.new }}</p>
                <p>Pending: {{ my_order_analytics.pending }}</p>
                <p>Confirmed: {{ my_order_analytics.confirmed }}</p>
                <p>Completed: {{ my_order_analytics.completed }}</p>
            </div>
        </div>
    </div>
    ...
    <div id="myProductsSection" class="tab-content">
        <button id="createListingTab" class="p-2 font-semibold text-white border-b-2 border-transparent hover:bg-teal-200 focus:outline-none tab-button bg-teal-700 rounded-xl">Create Listing</button>
        {% if user.userprofile.role == 'farmer' %}                       
            <!-- Listings Grid -->
